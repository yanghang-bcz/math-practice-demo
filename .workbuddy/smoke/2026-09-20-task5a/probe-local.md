...
| 错答落到模型（引擎判不了） | 193 |
| **合法写法被误拒（真实误杀）** | **0** |
| 合法写法被拒，但原因是该题标准答案本身就错 | 4 |
| 合法写法落到模型 | 52 |
| 确定性覆盖率 · 错答探针 | 51.1%（标量 132 + 结构 70） |
| 确定性覆盖率 · 合法探针 | 69.6%（标量 83 + 结构 36） |

> 标准答案本身未通过独立验证的题（4 道）：
> limit-L8-3、limit-L10-2、limit-L12-2、integral-L4-2
>
> 这些题上的「拒绝」是引擎抓对了，不是误杀 —— 所以从上表的真实误拒数里剔除。
> 它们属于生成闸门的责任范围（见 Task 5A 回归语料），不属于判题。
...
| 指标 | 只标量 | ＋结构层 | ＋常量/发散/中心 |
| --- | --- | --- | --- |
| 错答探针由确定性引擎判死 | 4.3%（17/395） | 43.0%（170/395） | 51.1%（202/395） |
| 错答探针落到模型 | 378/395 | 225/395 | 193/395 |
| 合法探针由确定性引擎判死 | 7.6%（13/171） | 53.8%（92/171） | 69.6%（119/171） |
...
## 合法写法没被确定性判定（这一侧是「多问一次模型」的代价，不是误批）

带 ⚠ 的行落在「标准答案本身有问题」的题上 —— 那里的拒绝是对的。

| 题 | 模块 | 参考答案 | 探针 | 提交的答案 | 本地结论 | 备注 |
| --- | --- | --- | --- | --- | --- | --- |
...
| integral-L4-2 | integral | `3\ln|x-2|-2\ln|x-1|+C` | paren_wrap | `\left(3\ln|x-2|-2\ln|x-1|+C\right)` | not_equivalent | ⚠ 该题标准答案本身有问题 |
| integral-L4-2 | integral | `3\ln|x-2|-2\ln|x-1|+C` | double_negation | `-\left(-\left(3\ln|x-2|-2\ln|x-1|+C\right)\right)` | not_equivalent | ⚠ 该题标准答案本身有问题 |
| integral-L4-2 | integral | `3\ln|x-2|-2\ln|x-1|+C` | times_one | `1\cdot\left(3\ln|x-2|-2\ln|x-1|+C\right)` | not_equivalent | ⚠ 该题标准答案本身有问题 |
| integral-L4-2 | integral | `3\ln|x-2|-2\ln|x-1|+C` | wrapped_twice | `\frac12\left(2\left(3\ln|x-2|-2\ln|x-1|+C\right)\right)` | not_equivalent | ⚠ 该题标准答案本身有问题 |
...
| limit-L4-1 | limit | L4 | double_wrapped | wrong | `2\left(1/6\right)` | not_equivalent | false | scalar |
| limit-L4-1 | limit | L4 | sign_flip | wrong | `-\left(1/6\right)` | not_equivalent | false | scalar |
| limit-L4-1 | limit | L4 | double_paren | wrong | `2(1/6)` | not_equivalent | false | scalar |
| limit-L4-1 | limit | L4 | double_cdot | wrong | `2\cdot\left(1/6\right)` | not_equivalent | false | scalar |
| limit-L4-1 | limit | L4 | double_times | wrong | `2\times\left(1/6\right)` | not_equivalent | false | scalar |
| limit-L4-1 | limit | L4 | half_shorthand | wrong | `\frac12\left(1/6\right)` | not_equivalent | false | scalar |
| limit-L4-1 | limit | L4 | plus_one | wrong | `\left(1/6\right)+1` | not_equivalent | false | scalar |
| limit-L4-1 | limit | L4 | minus_one | wrong | `\left(1/6\right)-1` | not_equivalent | false | scalar |
| limit-L4-1 | limit | L4 | paren_wrap | valid | `\left(1/6\right)` | equivalent | true | scalar |
| limit-L4-1 | limit | L4 | double_negation | valid | `-\left(-\left(1/6\right)\right)` | equivalent | true | scalar |
| limit-L4-1 | limit | L4 | times_one | valid | `1\cdot\left(1/6\right)` | equivalent | true | scalar |
| limit-L4-1 | limit | L4 | wrapped_twice | valid | `\frac12\left(2\left(1/6\right)\right)` | equivalent | true | scalar |
...
| limit-L6-1 | limit | L6 | far_number | wrong | `999999` | not_equivalent | false | scalar |
| limit-L6-1 | limit | L6 | double_wrapped | wrong | `2\left(\frac{2}{\pi}\right)` | not_equivalent | false | scalar |
| limit-L6-1 | limit | L6 | sign_flip | wrong | `-\left(\frac{2}{\pi}\right)` | not_equivalent | false | scalar |
| limit-L6-1 | limit | L6 | double_paren | wrong | `2(\frac{2}{\pi})` | not_equivalent | false | scalar |
| limit-L6-1 | limit | L6 | double_cdot | wrong | `2\cdot\left(\frac{2}{\pi}\right)` | not_equivalent | false | scalar |
| limit-L6-1 | limit | L6 | double_times | wrong | `2\times\left(\frac{2}{\pi}\right)` | not_equivalent | false | scalar |
| limit-L6-1 | limit | L6 | half_shorthand | wrong | `\frac12\left(\frac{2}{\pi}\right)` | not_equivalent | false | scalar |
| limit-L6-1 | limit | L6 | plus_one | wrong | `\left(\frac{2}{\pi}\right)+1` | not_equivalent | false | scalar |
| limit-L6-1 | limit | L6 | minus_one | wrong | `\left(\frac{2}{\pi}\right)-1` | not_equivalent | false | scalar |
| limit-L6-1 | limit | L6 | paren_wrap | valid | `\left(\frac{2}{\pi}\right)` | equivalent | true | scalar |
| limit-L6-1 | limit | L6 | double_negation | valid | `-\left(-\left(\frac{2}{\pi}\right)\right)` | equivalent | true | scalar |
| limit-L6-1 | limit | L6 | times_one | valid | `1\cdot\left(\frac{2}{\pi}\right)` | equivalent | true | scalar |
| limit-L6-1 | limit | L6 | wrapped_twice | valid | `\frac12\left(2\left(\frac{2}{\pi}\right)\right)` | equivalent | true | scalar |
...
| limit-L6-2 | limit | L6 | double_wrapped | wrong | `2\left(1\right)` | not_equivalent | false | scalar |
| limit-L6-2 | limit | L6 | sign_flip | wrong | `-\left(1\right)` | not_equivalent | false | scalar |
| limit-L6-2 | limit | L6 | double_paren | wrong | `2(1)` | not_equivalent | false | scalar |
| limit-L6-2 | limit | L6 | double_cdot | wrong | `2\cdot\left(1\right)` | not_equivalent | false | scalar |
| limit-L6-2 | limit | L6 | double_times | wrong | `2\times\left(1\right)` | not_equivalent | false | scalar |
| limit-L6-2 | limit | L6 | half_shorthand | wrong | `\frac12\left(1\right)` | not_equivalent | false | scalar |
...
| limit-L6-2 | limit | L6 | double_negation | valid | `-\left(-\left(1\right)\right)` | equivalent | true | scalar |
| limit-L6-2 | limit | L6 | times_one | valid | `1\cdot\left(1\right)` | equivalent | true | scalar |
| limit-L6-2 | limit | L6 | wrapped_twice | valid | `\frac12\left(2\left(1\right)\right)` | equivalent | true | scalar |
...
| limit-L8-1 | limit | L8 | double_wrapped | wrong | `2\left(1\right)` | not_equivalent | false | scalar |
| limit-L8-1 | limit | L8 | sign_flip | wrong | `-\left(1\right)` | not_equivalent | false | scalar |
| limit-L8-1 | limit | L8 | double_paren | wrong | `2(1)` | not_equivalent | false | scalar |
| limit-L8-1 | limit | L8 | double_cdot | wrong | `2\cdot\left(1\right)` | not_equivalent | false | scalar |
| limit-L8-1 | limit | L8 | double_times | wrong | `2\times\left(1\right)` | not_equivalent | false | scalar |
| limit-L8-1 | limit | L8 | half_shorthand | wrong | `\frac12\left(1\right)` | not_equivalent | false | scalar |
...
| limit-L8-1 | limit | L8 | double_negation | valid | `-\left(-\left(1\right)\right)` | equivalent | true | scalar |
| limit-L8-1 | limit | L8 | times_one | valid | `1\cdot\left(1\right)` | equivalent | true | scalar |
| limit-L8-1 | limit | L8 | wrapped_twice | valid | `\frac12\left(2\left(1\right)\right)` | equivalent | true | scalar |
...
| limit-L8-2 | limit | L8 | double_wrapped | wrong | `2\left(e^{-1/3}\right)` | not_equivalent | false | scalar |
| limit-L8-2 | limit | L8 | sign_flip | wrong | `-\left(e^{-1/3}\right)` | not_equivalent | false | scalar |
| limit-L8-2 | limit | L8 | double_paren | wrong | `2(e^{-1/3})` | not_equivalent | false | scalar |
| limit-L8-2 | limit | L8 | double_cdot | wrong | `2\cdot\left(e^{-1/3}\right)` | not_equivalent | false | scalar |
| limit-L8-2 | limit | L8 | double_times | wrong | `2\times\left(e^{-1/3}\right)` | not_equivalent | false | scalar |
| limit-L8-2 | limit | L8 | half_shorthand | wrong | `\frac12\left(e^{-1/3}\right)` | not_equivalent | false | scalar |
| limit-L8-2 | limit | L8 | plus_one | wrong | `\left(e^{-1/3}\right)+1` | not_equivalent | false | scalar |
| limit-L8-2 | limit | L8 | minus_one | wrong | `\left(e^{-1/3}\right)-1` | not_equivalent | false | scalar |
| limit-L8-2 | limit | L8 | paren_wrap | valid | `\left(e^{-1/3}\right)` | equivalent | true | scalar |
| limit-L8-2 | limit | L8 | double_negation | valid | `-\left(-\left(e^{-1/3}\right)\right)` | equivalent | true | scalar |
| limit-L8-2 | limit | L8 | times_one | valid | `1\cdot\left(e^{-1/3}\right)` | equivalent | true | scalar |
| limit-L8-2 | limit | L8 | wrapped_twice | valid | `\frac12\left(2\left(e^{-1/3}\right)\right)` | equivalent | true | scalar |
...
| limit-L8-3 | limit | L8 | double_wrapped | wrong | `2\left(-4\right)` | not_equivalent | false | scalar |
| limit-L8-3 | limit | L8 | sign_flip | wrong | `-\left(-4\right)` | not_equivalent | false | structural |
| limit-L8-3 | limit | L8 | double_paren | wrong | `2(-4)` | not_equivalent | false | scalar |
| limit-L8-3 | limit | L8 | double_cdot | wrong | `2\cdot\left(-4\right)` | not_equivalent | false | scalar |
| limit-L8-3 | limit | L8 | double_times | wrong | `2\times\left(-4\right)` | not_equivalent | false | scalar |
| limit-L8-3 | limit | L8 | half_shorthand | wrong | `\frac12\left(-4\right)` | not_equivalent | false | scalar |
| limit-L8-3 | limit | L8 | plus_one | wrong | `\left(-4\right)+1` | not_equivalent | false | structural |
| limit-L8-3 | limit | L8 | minus_one | wrong | `\left(-4\right)-1` | not_equivalent | false | structural |
| limit-L8-3 | limit | L8 | paren_wrap | valid | `\left(-4\right)` | equivalent | true | scalar |
| limit-L8-3 | limit | L8 | double_negation | valid | `-\left(-\left(-4\right)\right)` | equivalent | true | scalar |
| limit-L8-3 | limit | L8 | times_one | valid | `1\cdot\left(-4\right)` | equivalent | true | scalar |
| limit-L8-3 | limit | L8 | wrapped_twice | valid | `\frac12\left(2\left(-4\right)\right)` | equivalent | true | scalar |
...
| limit-L10-1 | limit | L10 | double_wrapped | wrong | `2\left(-\frac{1}{3}\right)` | not_equivalent | false | scalar |
| limit-L10-1 | limit | L10 | sign_flip | wrong | `-\left(-\frac{1}{3}\right)` | not_equivalent | false | scalar |
| limit-L10-1 | limit | L10 | double_paren | wrong | `2(-\frac{1}{3})` | not_equivalent | false | scalar |
| limit-L10-1 | limit | L10 | double_cdot | wrong | `2\cdot\left(-\frac{1}{3}\right)` | not_equivalent | false | scalar |
| limit-L10-1 | limit | L10 | double_times | wrong | `2\times\left(-\frac{1}{3}\right)` | not_equivalent | false | scalar |
| limit-L10-1 | limit | L10 | half_shorthand | wrong | `\frac12\left(-\frac{1}{3}\right)` | not_equivalent | false | scalar |
| limit-L10-1 | limit | L10 | plus_one | wrong | `\left(-\frac{1}{3}\right)+1` | not_equivalent | false | scalar |
| limit-L10-1 | limit | L10 | minus_one | wrong | `\left(-\frac{1}{3}\right)-1` | not_equivalent | false | scalar |
| limit-L10-1 | limit | L10 | paren_wrap | valid | `\left(-\frac{1}{3}\right)` | equivalent | true | scalar |
| limit-L10-1 | limit | L10 | double_negation | valid | `-\left(-\left(-\frac{1}{3}\right)\right)` | equivalent | true | scalar |
| limit-L10-1 | limit | L10 | times_one | valid | `1\cdot\left(-\frac{1}{3}\right)` | equivalent | true | scalar |
| limit-L10-1 | limit | L10 | wrapped_twice | valid | `\frac12\left(2\left(-\frac{1}{3}\right)\right)` | equivalent | true | scalar |
...
| limit-L10-2 | limit | L10 | double_wrapped | wrong | `2\left(-\frac{1}{6}\right)` | not_equivalent | false | scalar |
| limit-L10-2 | limit | L10 | sign_flip | wrong | `-\left(-\frac{1}{6}\right)` | not_equivalent | false | scalar |
| limit-L10-2 | limit | L10 | double_paren | wrong | `2(-\frac{1}{6})` | not_equivalent | false | scalar |
| limit-L10-2 | limit | L10 | double_cdot | wrong | `2\cdot\left(-\frac{1}{6}\right)` | not_equivalent | false | scalar |
| limit-L10-2 | limit | L10 | double_times | wrong | `2\times\left(-\frac{1}{6}\right)` | not_equivalent | false | scalar |
| limit-L10-2 | limit | L10 | half_shorthand | wrong | `\frac12\left(-\frac{1}{6}\right)` | not_equivalent | false | scalar |
| limit-L10-2 | limit | L10 | plus_one | wrong | `\left(-\frac{1}{6}\right)+1` | not_equivalent | false | scalar |
| limit-L10-2 | limit | L10 | minus_one | wrong | `\left(-\frac{1}{6}\right)-1` | not_equivalent | false | scalar |
| limit-L10-2 | limit | L10 | paren_wrap | valid | `\left(-\frac{1}{6}\right)` | equivalent | true | scalar |
| limit-L10-2 | limit | L10 | double_negation | valid | `-\left(-\left(-\frac{1}{6}\right)\right)` | equivalent | true | scalar |
| limit-L10-2 | limit | L10 | times_one | valid | `1\cdot\left(-\frac{1}{6}\right)` | equivalent | true | scalar |
| limit-L10-2 | limit | L10 | wrapped_twice | valid | `\frac12\left(2\left(-\frac{1}{6}\right)\right)` | equivalent | true | scalar |
...
| limit-L12-2 | limit | L12 | far_number | wrong | `999999` | not_equivalent | false | scalar |
| limit-L12-2 | limit | L12 | double_wrapped | wrong | `2\left(-\frac{2447e}{5760}\right)` | not_equivalent | false | scalar |
| limit-L12-2 | limit | L12 | sign_flip | wrong | `-\left(-\frac{2447e}{5760}\right)` | not_equivalent | false | scalar |
| limit-L12-2 | limit | L12 | double_paren | wrong | `2(-\frac{2447e}{5760})` | not_equivalent | false | scalar |
| limit-L12-2 | limit | L12 | double_cdot | wrong | `2\cdot\left(-\frac{2447e}{5760}\right)` | not_equivalent | false | scalar |
| limit-L12-2 | limit | L12 | double_times | wrong | `2\times\left(-\frac{2447e}{5760}\right)` | not_equivalent | false | scalar |
| limit-L12-2 | limit | L12 | half_shorthand | wrong | `\frac12\left(-\frac{2447e}{5760}\right)` | not_equivalent | false | scalar |
| limit-L12-2 | limit | L12 | plus_one | wrong | `\left(-\frac{2447e}{5760}\right)+1` | not_equivalent | false | scalar |
| limit-L12-2 | limit | L12 | minus_one | wrong | `\left(-\frac{2447e}{5760}\right)-1` | not_equivalent | false | scalar |
| limit-L12-2 | limit | L12 | paren_wrap | valid | `\left(-\frac{2447e}{5760}\right)` | equivalent | true | scalar |
| limit-L12-2 | limit | L12 | double_negation | valid | `-\left(-\left(-\frac{2447e}{5760}\right)\right)` | equivalent | true | scalar |
| limit-L12-2 | limit | L12 | times_one | valid | `1\cdot\left(-\frac{2447e}{5760}\right)` | equivalent | true | scalar |
| limit-L12-2 | limit | L12 | wrapped_twice | valid | `\frac12\left(2\left(-\frac{2447e}{5760}\right)\right)` | equivalent | true | scalar |
...
| derivative-L4-2 | derivative | L4 | double_negation | valid | `-\left(-\left(0\right)\right)` | equivalent | true | scalar |
| derivative-L4-2 | derivative | L4 | times_one | valid | `1\cdot\left(0\right)` | equivalent | true | scalar |
| derivative-L4-2 | derivative | L4 | wrapped_twice | valid | `\frac12\left(2\left(0\right)\right)` | equivalent | true | scalar |
...
| derivative-L6-2 | derivative | L6 | double_negation | valid | `-\left(-\left(0\right)\right)` | equivalent | true | scalar |
| derivative-L6-2 | derivative | L6 | times_one | valid | `1\cdot\left(0\right)` | equivalent | true | scalar |
| derivative-L6-2 | derivative | L6 | wrapped_twice | valid | `\frac12\left(2\left(0\right)\right)` | equivalent | true | scalar |
...
| derivative-L12-4 | derivative | L12 | double_negation | valid | `-\left(-\left(0\right)\right)` | equivalent | true | scalar |
| derivative-L12-4 | derivative | L12 | times_one | valid | `1\cdot\left(0\right)` | equivalent | true | scalar |
| derivative-L12-4 | derivative | L12 | wrapped_twice | valid | `\frac12\left(2\left(0\right)\right)` | equivalent | true | scalar |
...
| integral-L4-3 | integral | L4 | far_number | wrong | `999999` | not_equivalent | false | scalar |
| integral-L4-3 | integral | L4 | double_wrapped | wrong | `2\left(\frac{\pi}{4}\right)` | not_equivalent | false | scalar |
| integral-L4-3 | integral | L4 | sign_flip | wrong | `-\left(\frac{\pi}{4}\right)` | not_equivalent | false | scalar |
| integral-L4-3 | integral | L4 | double_paren | wrong | `2(\frac{\pi}{4})` | not_equivalent | false | scalar |
| integral-L4-3 | integral | L4 | double_cdot | wrong | `2\cdot\left(\frac{\pi}{4}\right)` | not_equivalent | false | scalar |
| integral-L4-3 | integral | L4 | double_times | wrong | `2\times\left(\frac{\pi}{4}\right)` | not_equivalent | false | scalar |
| integral-L4-3 | integral | L4 | half_shorthand | wrong | `\frac12\left(\frac{\pi}{4}\right)` | not_equivalent | false | scalar |
| integral-L4-3 | integral | L4 | plus_one | wrong | — | skip | — | — |
| integral-L4-3 | integral | L4 | minus_one | wrong | — | skip | — | — |
| integral-L4-3 | integral | L4 | paren_wrap | valid | `\left(\frac{\pi}{4}\right)` | equivalent | true | scalar |
| integral-L4-3 | integral | L4 | double_negation | valid | `-\left(-\left(\frac{\pi}{4}\right)\right)` | equivalent | true | scalar |
| integral-L4-3 | integral | L4 | times_one | valid | `1\cdot\left(\frac{\pi}{4}\right)` | equivalent | true | scalar |
| integral-L4-3 | integral | L4 | wrapped_twice | valid | `\frac12\left(2\left(\frac{\pi}{4}\right)\right)` | equivalent | true | scalar |
...
| integral-L8-1 | integral | L8 | double_wrapped | wrong | `2\left(\frac{\pi}{4}\right)` | not_equivalent | false | scalar |
| integral-L8-1 | integral | L8 | sign_flip | wrong | `-\left(\frac{\pi}{4}\right)` | not_equivalent | false | scalar |
| integral-L8-1 | integral | L8 | double_paren | wrong | `2(\frac{\pi}{4})` | not_equivalent | false | scalar |
| integral-L8-1 | integral | L8 | double_cdot | wrong | `2\cdot\left(\frac{\pi}{4}\right)` | not_equivalent | false | scalar |
| integral-L8-1 | integral | L8 | double_times | wrong | `2\times\left(\frac{\pi}{4}\right)` | not_equivalent | false | scalar |
| integral-L8-1 | integral | L8 | half_shorthand | wrong | `\frac12\left(\frac{\pi}{4}\right)` | not_equivalent | false | scalar |
| integral-L8-1 | integral | L8 | plus_one | wrong | — | skip | — | — |
| integral-L8-1 | integral | L8 | minus_one | wrong | — | skip | — | — |
| integral-L8-1 | integral | L8 | paren_wrap | valid | `\left(\frac{\pi}{4}\right)` | equivalent | true | scalar |
| integral-L8-1 | integral | L8 | double_negation | valid | `-\left(-\left(\frac{\pi}{4}\right)\right)` | equivalent | true | scalar |
| integral-L8-1 | integral | L8 | times_one | valid | `1\cdot\left(\frac{\pi}{4}\right)` | equivalent | true | scalar |
| integral-L8-1 | integral | L8 | wrapped_twice | valid | `\frac12\left(2\left(\frac{\pi}{4}\right)\right)` | equivalent | true | scalar |
